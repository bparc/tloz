...
#define CHR(Base,Offset) (Base + Offset*64)
...
enum
{
	...
	CHR_LINK_E = CHR(CHR_BANK3, 0),
	CHR_LINK_N = CHR(CHR_BANK3, 2),
	CHR_LINK_ATTACK_E = CHR(CHR_BANK3, 4),
	CHR_LINK_ATTACK_N = CHR(CHR_BANK3, 5),
	CHR_SWORD_E = CHR(CHR_BANK1, 4) + 32,
	CHR_SWORD_N = CHR(CHR_BANK3, 7) + 32 + (8 * 3),
	CHR_STAIR = CHR(CHR_BANK2, 0),
	CHR_FLOOR = CHR(CHR_BANK2, 1),
	CHR_WALL = CHR(CHR_BANK2, 16),
	CHR_DNG_WALL = CHR(CHR_BANK3, 57),
	CHR_ICON_LIFE = (CHR(CHR_BANK3, 53) + 8),
	CHR_OCTOROCK = (CHR(CHR_BANK2, 73) + 32),
	CHR_TEKTITE = CHR(CHR_BANK2, 80),
	CHR_OCTOCOK_BULLET = CHR(CHR_BANK2, 87)+32,
	CHR_KEESE = CHR(CHR_BANK2,113)+32,
	CHR_EFFECT_SPAWN = CHR(CHR_BANK3,24)+32,
};
...
static const int32_t PAL_BLUE_ALPHA[4] = { 0, RGB(0,60,60),RGB(0,116, 132),RGB(75,203,218) };
